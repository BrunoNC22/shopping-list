import { Categoria, CategoryNotFoundError, ResourceNotFoundError, type CategoryPersisterOutputPort, type GetCacheStorageOutputPort, type SetCacheStorageOutputPort } from "@shopping-list/domain"
