...
import { Categoria, SyncEventEnum, type AddEventSyncQueueOutputPort, type AnySyncEvent, type CategoryPersisterOutputPort, type IdGeneratorOutputPort, type SyncEngineOutputPort } from "@shopping-list/domain"
