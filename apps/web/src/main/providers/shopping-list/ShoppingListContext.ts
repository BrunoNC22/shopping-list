import type { CreateItemProps, EditItemProps, GetTotalByCategoryResponseItem, Item, ItemsByCategoryResponseItem } from "@shopping-list/domain";
import { createContext, useContext } from "react";

export interface IShoppingListContext {
  addItem(props: Omit<CreateItemProps, 'itemListId'>): Promise<void>
